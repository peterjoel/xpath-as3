package memorphic.xpath.tests.fixtures
{
	...
	public class XMLData
	{
		...
		public static function get fwossHomeXHTML():XML{
			return FWOSS_HOME.copy();
		}
		...
		[Embed(source="fwoss.xhtml", mimeType="application/octet-stream")]
		private static const FWOSS_HOME_RAW:Class;
		private static const FWOSS_HOME:XML = parseXML(new FWOSS_HOME_RAW());
