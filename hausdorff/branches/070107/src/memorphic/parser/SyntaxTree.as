package memorphic.parser
{
	...
	public class SyntaxTree
	{
		...
		protected function restartRule(ruleName:String):void
		{
		...
		private function undoRule(ruleName:String=null):RuleMarker
		{
			var t:Object;
			var marker:RuleMarker;
			if(ruleName == null){
				...
				while(!((marker = (stack.pop() as RuleMarker)) && marker.ruleName==ruleName));
